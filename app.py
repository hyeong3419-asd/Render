...
def build_prompt_with_database_info(query, base_prompt):
    ...
    if db_info:
        ...
        return (
            ...
            f"\n4. **Output Format**:\n"
            f"   - Deliver a concise and structured response, prioritizing clarity and relevance.\n"
            f"   - If using database information, clearly integrate it into your response.\n"
        ...
        return (
            ...
            f"### Task Instructions:\n"
            f"1. **Database Priority**:\n"
            f"   - If no database information is available, use general knowledge and logical reasoning to provide a complete response.\n"
            f"\n2. **Question Interpretation**:\n"
            f"   - Recognize the input as a user question, not a news article. Your role is to analyze the question and provide a logical, fact-based response.\n"
            f"\n3. **Context and Reasoning**:\n"
            f"   - Provide an informed opinion using validated reasoning and general knowledge.\n"
            f"   - Avoid assuming the input is a news article unless explicitly stated.\n"
            f"\n4. **Output Format**:\n"
            f"   - Deliver a concise and structured response, prioritizing clarity and relevance.\n"
            f"\n### User Question:\n{query}\n"
